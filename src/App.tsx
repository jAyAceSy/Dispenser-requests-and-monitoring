...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/new-request" element={<Protected roles={['insti_team']}><NewRequest /></Protected>} />
      <Route path="/my-requests" element={<Protected roles={['insti_team']}><MyRequests /></Protected>} />
